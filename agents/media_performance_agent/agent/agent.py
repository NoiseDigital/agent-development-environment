...
# ToolboxCore import for direct tool access (Cloud Run compatible)
...
# --- MediaPerformanceAgent Class (for A2A server) ---
# This class wraps the root_agent and provides the 'invoke' method
# expected by AgentTaskManager.
class MediaPerformanceAgent:
    """
    Agent to answer questions about Media Performance using Gemini and MCP tools.
    ...
    def __init__(self):
        ...
        logger.info("MediaPerformanceAgent (wrapper) initialized.")
