    ...
    <div className="pointer-events-none relative">
      <div className="pointer-events-auto px-4 pb-6 pt-2">
        <form onSubmit={handleSubmit} className="mx-auto w-full max-w-2xl">
          <div
            className={`group relative flex items-center gap-2 rounded-full bg-zinc-900/60 pl-5 pr-2 py-2 backdrop-blur-md transition-all duration-300 ring-1 ring-white/5 focus-within:ring-white/15 focus-within:bg-zinc-900/80 ${
