...
// Presentation only (icons) — labels/routes/descriptions/enablement come from
// the tenant config (tenants/modules.json). Add a module → add its icon here.
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center h-full px-6 overflow-auto">
      <div className="w-full max-w-2xl">
        ...
        <div className="mb-12 text-center">
          ...
          <div className="flex items-end justify-center gap-2 mb-5">
            <Image
              ...
              width={140}
              height={38}
              className={`h-9 w-auto${branding.logoInvertOnLight ? ' light:invert' : ''}`}
            />
          </div>
        ...
        {/* Section cards — only the tenant's enabled modules */}
