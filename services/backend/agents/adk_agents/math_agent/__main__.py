...
from services.backend.agents.adk_agents.math_agent.task_manager import AgentTaskManager  # noqa: E402
...
@click.option(
    ...
    default=8080,
    type=int,
    help="The port number for the server to listen on. Default is 8080.",
)
def main(host: str, port: int):
    ...
    skill = AgentSkill(
        ...
        examples=["Add 2+2", "Subtract 10-3"],
    )
